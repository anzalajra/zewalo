...
class SetupWizard extends Page implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        $this->currentStep = $tenant->getSetupCurrentStep();
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ...
            ->components([
                Tabs::make('setup')
                    ->tabs([
                        Tab::make(__('admin.setup_wizard.step1_title'))
                        ...
                        Tab::make(__('admin.setup_wizard.step2_title'))
                        ...
                        Tab::make(__('admin.setup_wizard.step3_title'))
                        ...
                        Tab::make(__('admin.setup_wizard.step4_title'))
    ...
    public function submit(): void
    {
        ...
        // Save Step 2: Operational schedule
        ...
        // Save Step 4: Run template seeder if requested
