...
<head>
    ...
    <title>{{ __('landing.sol_baby.page_title') }}</title>
...
<body class="font-display bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 antialiased">
                ...
                <div class="flex-1 space-y-6">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="/register-tenant"
                            ...
                            {{ __('landing.sol_baby.hero_cta_rent') }}
                        </a>
                        <a href="/contact"
                            ...
                            {{ __('landing.sol_baby.hero_cta_how') }}
                        </a>
                    </div>
                </div>
                <div class="flex-1 relative">
                    <div class="aspect-square rounded-3xl bg-primary/5 overflow-hidden relative border-8 border-white dark:border-slate-800 shadow-2xl">
                        <img class="w-full h-full object-cover"
                            data-alt="{{ __('landing.sol_baby.hero_image_alt') }}"
                    ...
                    <div class="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl flex items-center gap-4 border border-slate-100 dark:border-slate-700">
                        ...
                        <div>
                            <p class="text-sm font-bold">{{ __('landing.sol_baby.hero_badge_title') }}</p>
                            <p class="text-xs text-slate-500">{{ __('landing.sol_baby.hero_badge_subtitle') }}</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="bg-white dark:bg-slate-900/50 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-10 gap-6">
                <div class="max-w-xl">
                    <h2 class="text-3xl font-bold mb-4">{{ __('landing.sol_baby.category_title') }}</h2>
                    <p class="text-slate-600 dark:text-slate-400">{{ __('landing.sol_baby.category_description') }}</p>
                </div>
                <div class="flex gap-2 overflow-x-auto pb-2 w-full md:w-auto">
                    ...
                    <button class="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 px-4 py-2 rounded-lg text-sm font-semibold whitespace-nowrap">
                        {{ __('landing.sol_baby.age_6_12') }}
                    </button>
                    <button class="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 px-4 py-2 rounded-lg text-sm font-semibold whitespace-nowrap">
                        {{ __('landing.sol_baby.age_1_3') }}
                    </button>
                    <button class="flex items-center gap-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 px-4 py-2 rounded-lg text-sm font-semibold whitespace-nowrap">
                        {{ __('landing.sol_baby.age_3_plus') }}
                    </button>
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-background-light dark:bg-slate-800 rounded-2xl p-4 transition-transform hover:-translate-y-1">
                    <div class="aspect-[4/3] rounded-xl overflow-hidden mb-4 bg-white">
                        <img class="w-full h-full object-cover"
                            data-alt="{{ __('landing.sol_baby.product1_image_alt') }}"
                    ...
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="font-bold text-lg">{{ __('landing.sol_baby.product1_name') }}</h3>
                        <span class="text-primary font-bold">{{ __('landing.sol_baby.product1_price') }}</span>
                    </div>
                    ...
                    <button class="w-full py-2 border border-primary text-primary font-bold rounded-lg hover:bg-primary hover:text-white transition-colors">{{ __('landing.sol_baby.product_select') }}</button>
                </div>
                <!-- Product Card 2 -->
                <div class="bg-background-light dark:bg-slate-800 rounded-2xl p-4 transition-transform hover:-translate-y-1">
                    <div class="aspect-[4/3] rounded-xl overflow-hidden mb-4 bg-white">
                        <img class="w-full h-full object-cover" data-alt="{{ __('landing.sol_baby.product2_image_alt') }}"
                    ...
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="font-bold text-lg">{{ __('landing.sol_baby.product2_name') }}</h3>
                        <span class="text-primary font-bold">{{ __('landing.sol_baby.product2_price') }}</span>
                    </div>
                    <p class="text-xs text-slate-500 mb-4">{{ __('landing.sol_baby.product2_age_range') }}</p>
                    <button class="w-full py-2 border border-primary text-primary font-bold rounded-lg hover:bg-primary hover:text-white transition-colors">{{ __('landing.sol_baby.product_select') }}</button>
                </div>
                <!-- Product Card 3 -->
                <div class="bg-background-light dark:bg-slate-800 rounded-2xl p-4 transition-transform hover:-translate-y-1">
                    <div class="aspect-[4/3] rounded-xl overflow-hidden mb-4 bg-white">
                        <img class="w-full h-full object-cover" data-alt="{{ __('landing.sol_baby.product3_image_alt') }}"
                    ...
                    <div class="flex justify-between items-start mb-2">
                        <h3 class="font-bold text-lg">{{ __('landing.sol_baby.product3_name') }}</h3>
                        <span class="text-primary font-bold">{{ __('landing.sol_baby.product3_price') }}</span>
                    </div>
                    <div class="flex gap-2 mb-4">
                        <span class="px-2 py-1 bg-slate-200 dark:bg-slate-700 rounded text-[10px] font-bold">{{ __('landing.sol_baby.size_small') }}</span>
                        <span class="px-2 py-1 bg-primary/20 text-primary rounded text-[10px] font-bold">{{ __('landing.sol_baby.size_standard') }}</span>
                    </div>
                    <button class="w-full py-2 border border-primary text-primary font-bold rounded-lg hover:bg-primary hover:text-white transition-colors">{{ __('landing.sol_baby.product_select') }}</button>
                </div>
            </div>
    ...
    <section class="py-16 bg-background-light dark:bg-background-dark">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold mb-4">{{ __('landing.sol_baby.hygiene_title') }}</h2>
                <p class="text-slate-600 dark:text-slate-400">{{ __('landing.sol_baby.hygiene_description') }}</p>
            </div>
            <div class="space-y-0">
                <div class="grid grid-cols-[48px_1fr] gap-x-6">
                    ...
                    <div class="pb-8">
                        <h4 class="text-xl font-bold mb-1">{{ __('landing.sol_baby.hygiene_step1_title') }}</h4>
                        <p class="text-slate-600 dark:text-slate-400">{{ __('landing.sol_baby.hygiene_step1_description') }}</p>
                        <div class="mt-2 flex items-center gap-2 text-xs font-semibold text-primary">
                            <span class="material-symbols-outlined text-sm">check_circle</span>
                            {{ __('landing.sol_baby.hygiene_step1_badge') }}
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-[48px_1fr] gap-x-6">
                    ...
                    <div class="pb-8">
                        <h4 class="text-xl font-bold mb-1">{{ __('landing.sol_baby.hygiene_step2_title') }}</h4>
                        <p class="text-slate-600 dark:text-slate-400">{{ __('landing.sol_baby.hygiene_step2_description') }}</p>
                        <div class="mt-2 flex items-center gap-2 text-xs font-semibold text-primary">
                            <span class="material-symbols-outlined text-sm">check_circle</span>
                            {{ __('landing.sol_baby.hygiene_step2_badge') }}
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-[48px_1fr] gap-x-6">
                    ...
                    <div>
                        <h4 class="text-xl font-bold mb-1">{{ __('landing.sol_baby.hygiene_step3_title') }}</h4>
                        <p class="text-slate-600 dark:text-slate-400">{{ __('landing.sol_baby.hygiene_step3_description') }}</p>
                        <div class="mt-2 flex items-center gap-2 text-xs font-semibold text-primary">
                            <span class="material-symbols-outlined text-sm">check_circle</span>
                            {{ __('landing.sol_baby.hygiene_step3_badge') }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-xl flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
                ...
                <div class="shrink-0">
                    <img class="w-32 h-32 rounded-2xl object-cover ring-4 ring-primary/20"
                        data-alt="{{ __('landing.sol_baby.testimonial_image_alt') }}"
                ...
                <div class="space-y-4">
                    ...
                    <p class="text-xl italic font-medium text-slate-700 dark:text-slate-300">
                        "{{ __('landing.sol_baby.testimonial_quote') }}"
                    </p>
                    <div>
                        <h4 class="font-bold text-lg">{{ __('landing.sol_baby.testimonial_name') }}</h4>
                        <p class="text-primary text-sm font-semibold">{{ __('landing.sol_baby.testimonial_role') }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-16 max-w-3xl mx-auto px-4">
        <h2 class="text-3xl font-bold mb-8 text-center">{{ __('landing.sol_baby.faq_title') }}</h2>
        <div class="space-y-4">
            <div class="group bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
                <button class="w-full flex items-center justify-between p-5 text-left font-bold">
                    <span>{{ __('landing.sol_baby.faq1_question') }}</span>
                ...
                <div class="px-5 pb-5 text-slate-600 dark:text-slate-400">
                    {{ __('landing.sol_baby.faq1_answer') }}
                </div>
            </div>
            <div class="group bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
                <button class="w-full flex items-center justify-between p-5 text-left font-bold">
                    <span>{{ __('landing.sol_baby.faq2_question') }}</span>
                    <span class="material-symbols-outlined group-hover:rotate-180 transition-transform">expand_more</span>
                </button>
                <div class="px-5 pb-5 text-slate-600 dark:text-slate-400">
                    {{ __('landing.sol_baby.faq2_answer') }}
                </div>
            </div>
            <div class="group bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
                <button class="w-full flex items-center justify-between p-5 text-left font-bold">
                    <span>{{ __('landing.sol_baby.faq3_question') }}</span>
                    <span class="material-symbols-outlined group-hover:rotate-180 transition-transform">expand_more</span>
                </button>
                <div class="px-5 pb-5 text-slate-600 dark:text-slate-400">
                    {{ __('landing.sol_baby.faq3_answer') }}
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 px-4">
        <div class="max-w-5xl mx-auto bg-slate-900 dark:bg-primary rounded-[2rem] p-8 md:p-16 text-center text-white relative overflow-hidden">
            ...
            <div class="relative z-10 space-y-8">
                <h2 class="text-4xl md:text-5xl font-black">{{ __('landing.sol_baby.cta_title') }}</h2>
                <p class="text-lg text-slate-300 dark:text-white/80 max-w-2xl mx-auto">
                    {!! __('landing.sol_baby.cta_description') !!}
                </p>
