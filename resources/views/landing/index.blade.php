...
<html class="" lang="{{ str_replace('_', '-', app()->getLocale()) }}"><head>
<meta charset="utf-8"/>
<meta content="width=device-width, initial-scale=1.0" name="viewport"/>
<title>{{ __('landing.index.page_title') }}</title>
...
<h1 class="text-4xl sm:text-6xl font-black tracking-tight mb-6 leading-[1.1]">
                    {{ __('landing.index.hero_title_prefix') }} <span class="text-primary">{{ __('landing.index.hero_title_highlight') }}</span>
</h1>
<p class="text-lg sm:text-xl text-slate-600 dark:text-slate-400 mb-10 leading-relaxed">
                    {{ __('landing.index.hero_subtitle') }}
                </p>
...
<button class="w-full sm:w-auto bg-primary hover:bg-primary/90 text-white text-lg font-bold px-8 py-4 rounded-xl transition-all shadow-xl shadow-primary/25">
                        {{ __('landing.index.hero_cta_trial') }}
                    </button>
<button class="w-full sm:w-auto bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 font-semibold px-8 py-4 rounded-xl transition-all">
                        {{ __('landing.index.hero_cta_demo') }}
                    </button>
</div>
</div>
...
<h2 class="text-4xl font-black mb-4 tracking-tight">{{ __('landing.index.feat_heading') }}</h2>
<p class="text-slate-600 max-w-2xl mx-auto">{{ __('landing.index.feat_subheading') }}</p>
</div>
...
<h3 class="text-xl font-bold mb-3">{{ __('landing.index.feat_live_stock') }}</h3>
<p class="text-slate-600 text-sm leading-relaxed">
            {{ __('landing.index.feat_live_stock_desc') }}
        </p>
</div>
</div>
...
<h3 class="text-2xl font-bold mb-3">{{ __('landing.index.feat_inventory') }}</h3>
<p class="text-slate-600 leading-relaxed max-w-md">
            {{ __('landing.index.feat_inventory_desc') }}
        </p>
</div>
</div>
...
<h3 class="text-xl font-bold mb-3">{{ __('landing.index.feat_booking') }}</h3>
<p class="text-slate-600 text-sm leading-relaxed">
            {{ __('landing.index.feat_booking_desc') }}
        </p>
</div>
</div>
...
<h3 class="text-xl font-bold mb-3">{{ __('landing.index.feat_invoicing') }}</h3>
<p class="text-slate-600 text-sm leading-relaxed">
            {{ __('landing.index.feat_invoicing_desc') }}
        </p>
</div>
</div>
<!-- Feature 5: Laporan -->
...
<h3 class="text-xl font-bold mb-3">{{ __('landing.index.feat_reports') }}</h3>
<p class="text-slate-600 text-sm leading-relaxed">
            {{ __('landing.index.feat_reports_desc') }}
        </p>
</div>
</div></div>
</div>
...
<section class="py-20">
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<h2 class="text-3xl font-bold mb-12">{{ __('landing.index.case_heading') }}</h2>
...
<span class="bg-primary text-xs font-bold text-white px-2 py-1 rounded">{{ __('landing.index.case_badge_photography') }}</span>
</div>
</div>
<h4 class="text-lg font-bold">{{ __('landing.index.case_camera_title') }}</h4>
<p class="text-slate-600 dark:text-slate-400 text-sm">{{ __('landing.index.case_camera_desc') }}</p>
</div>
<!-- Case 2 -->
<div class="group cursor-pointer">
<div class="aspect-[4/3] rounded-xl overflow-hidden mb-4 relative">
...
<div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
<div class="absolute bottom-4 left-4">
<span class="bg-primary text-xs font-bold text-white px-2 py-1 rounded">{{ __('landing.index.case_badge_outdoor') }}</span>
</div>
</div>
<h4 class="text-lg font-bold">{{ __('landing.index.case_camping_title') }}</h4>
<p class="text-slate-600 dark:text-slate-400 text-sm">{{ __('landing.index.case_camping_desc') }}</p>
</div>
<!-- Case 3 -->
<div class="group cursor-pointer">
<div class="aspect-[4/3] rounded-xl overflow-hidden mb-4 relative">
...
<div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
<div class="absolute bottom-4 left-4">
<span class="bg-primary text-xs font-bold text-white px-2 py-1 rounded">{{ __('landing.index.case_badge_transport') }}</span>
</div>
</div>
<h4 class="text-lg font-bold">{{ __('landing.index.case_car_title') }}</h4>
<p class="text-slate-600 dark:text-slate-400 text-sm">{{ __('landing.index.case_car_desc') }}</p>
</div>
</div>
</div>
</section>
...
<h2 class="text-3xl font-bold mb-4">{{ __('landing.index.pricing_heading') }}</h2>
<div class="flex items-center justify-center gap-4 mt-6">
<span class="text-sm font-medium" :class="frequency === 'monthly' ? 'text-slate-900' : 'text-slate-500'">{{ __('landing.index.pricing_monthly') }}</span>
...
<span class="text-sm font-medium" :class="frequency === 'yearly' ? 'text-slate-900' : 'text-slate-500'">{{ __('landing.index.pricing_yearly') }} <span class="text-green-500 font-bold">{{ __('landing.index.pricing_yearly_discount') }}</span></span>
</div>
</div>
@php
...
<h3 class="text-lg font-bold mb-2">{{ __('landing.index.pricing_free') }}</h3>
<div class="flex items-baseline gap-1 mb-2">
<span class="text-4xl font-black">{{ $freePlan ? $freePlan['pricing']['formatted_monthly'] : '$0' }}</span>
<span class="text-slate-500">{{ __('landing.index.pricing_per_month') }}</span>
</div>
<p class="text-sm text-primary font-medium mb-6">{{ __('landing.index.pricing_free_forever') }}</p>
<ul class="space-y-4 mb-8 flex-1">
<li class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-primary text-xl">check_circle</span>
            {{ __('landing.index.pricing_free_feat_orders') }}
        </li>
<li class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-primary text-xl">check_circle</span>
            {{ __('landing.index.pricing_free_feat_dashboard') }}
        </li>
</ul>
<button class="w-full py-3 rounded-lg border-2 border-slate-200 dark:border-slate-700 font-bold hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">{{ __('landing.index.pricing_cta_start') }}</button>
</div>
<!-- Basic -->
<div class="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-col">
<h3 class="text-lg font-bold mb-2">{{ __('landing.index.pricing_basic') }}</h3>
<div class="flex items-baseline gap-1 mb-2">
<span class="text-4xl font-black" x-text="frequency === 'monthly' ? '{{ $basicPlan ? $basicPlan['pricing']['formatted_monthly'] : '$19' }}' : '{{ $basicPlan ? $basicPlan['pricing']['formatted_yearly'] : '$15' }}'">{{ $basicPlan ? $basicPlan['pricing']['formatted_monthly'] : '$19' }}</span>
<span class="text-slate-500">{{ __('landing.index.pricing_per_month') }}</span>
</div>
<p class="text-sm text-primary font-medium mb-6">{{ __('landing.index.pricing_free_trial') }}</p>
<ul class="space-y-4 mb-8 flex-1">
<li class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-primary text-xl">check_circle</span>
            {{ __('landing.index.pricing_basic_feat_orders') }}
        </li>
<li class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-primary text-xl">check_circle</span>
            {{ __('landing.index.pricing_basic_feat_inventory') }}
        </li>
<li class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-primary text-xl">check_circle</span>
            {{ __('landing.index.pricing_basic_feat_staff') }}
        </li>
</ul>
<button class="w-full py-3 rounded-lg border-2 border-slate-200 dark:border-slate-700 font-bold hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">{{ __('landing.index.pricing_cta_choose') }}</button>
</div>
<!-- Pro -->
...
<div class="absolute -top-4 left-1/2 -translate-x-1/2 bg-primary text-white text-xs font-bold px-4 py-1 rounded-full uppercase tracking-wider">{{ __('landing.index.pricing_popular') }}</div>
<h3 class="text-lg font-bold mb-2">{{ __('landing.index.pricing_pro') }}</h3>
<div class="flex items-baseline gap-1 mb-2">
<span class="text-4xl font-black text-primary" x-text="frequency === 'monthly' ? '{{ $proPlan ? $proPlan['pricing']['formatted_monthly'] : '$49' }}' : '{{ $proPlan ? $proPlan['pricing']['formatted_yearly'] : '$39' }}'">{{ $proPlan ? $proPlan['pricing']['formatted_monthly'] : '$49' }}</span>
<span class="text-slate-500">{{ __('landing.index.pricing_per_month') }}</span>
</div>
<p class="text-sm text-primary font-medium mb-6">{{ __('landing.index.pricing_free_trial') }}</p>
<ul class="space-y-4 mb-8 flex-1">
<li class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-primary text-xl">check_circle</span>
            {{ __('landing.index.pricing_pro_feat_enterprise') }}
        </li>
<li class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-primary text-xl">check_circle</span>
            {{ __('landing.index.pricing_pro_feat_inventory') }}
        </li>
<li class="flex items-center gap-2 text-sm">
<span class="material-symbols-outlined text-primary text-xl">check_circle</span>
            {{ __('landing.index.pricing_pro_feat_staff') }}
        </li>
</ul>
<button class="w-full py-3 rounded-lg bg-primary text-white font-bold hover:bg-primary/90 transition-all shadow-lg shadow-primary/30">{{ __('landing.index.pricing_cta_trial') }}</button>
</div></div>
</div>
</section>
...
<section class="py-20">
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
<h2 class="text-3xl font-bold mb-12 text-center">{{ __('landing.index.testimonial_heading') }}</h2><div class="flex flex-wrap justify-center items-center gap-8 md:gap-16 mb-16 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
...
<p class="relative z-10 text-slate-700 dark:text-slate-300 mb-6">
                        "{{ __('landing.index.testimonial_1_quote') }}"
                    </p>
...
<div>
<p class="font-bold text-sm">{{ __('landing.index.testimonial_1_name') }}</p>
<p class="text-xs text-slate-500">{{ __('landing.index.testimonial_1_role') }}</p>
</div>
</div>
</div>
<!-- Testimonial 2 -->
...
<span class="material-symbols-outlined text-primary/20 text-6xl absolute top-4 left-4">format_quote</span>
<p class="relative z-10 text-slate-700 dark:text-slate-300 mb-6">
                        "{{ __('landing.index.testimonial_2_quote') }}"
                    </p>
<div class="flex items-center gap-4">
<div class="w-12 h-12 rounded-full overflow-hidden bg-slate-200">
...
<div>
<p class="font-bold text-sm">{{ __('landing.index.testimonial_2_name') }}</p>
<p class="text-xs text-slate-500">{{ __('landing.index.testimonial_2_role') }}</p>
</div>
</div>
</div>
<!-- Testimonial 3 -->
...
<span class="material-symbols-outlined text-primary/20 text-6xl absolute top-4 left-4">format_quote</span>
<p class="relative z-10 text-slate-700 dark:text-slate-300 mb-6">
                        "{{ __('landing.index.testimonial_3_quote') }}"
                    </p>
<div class="flex items-center gap-4">
<div class="w-12 h-12 rounded-full overflow-hidden bg-slate-200">
...
<div>
<p class="font-bold text-sm">{{ __('landing.index.testimonial_3_name') }}</p>
<p class="text-xs text-slate-500">{{ __('landing.index.testimonial_3_role') }}</p>
</div>
</div>
</div>
</div>
...
<h2 class="text-3xl sm:text-4xl font-black mb-6">{{ __('landing.index.cta_heading') }}</h2>
<p class="text-blue-100 text-lg mb-10 max-w-2xl mx-auto">
                        {{ __('landing.index.cta_description') }}
                    </p>
<button class="bg-white text-primary hover:bg-slate-100 text-lg font-bold px-10 py-4 rounded-xl transition-all shadow-xl">
                        {{ __('landing.index.cta_button') }}
                    </button>
<p class="mt-6 text-sm text-blue-200">{{ __('landing.index.cta_subtext') }}</p>
</div>
