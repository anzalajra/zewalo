...
<?php endif; ?>
                ...
                <a href="/register-tenant"
                    class="hidden md:inline-flex bg-primary hover:bg-primary/90 text-white text-sm font-bold px-5 py-2.5 rounded-lg transition-all shadow-lg shadow-primary/20"><?php echo e(__('common.get_started')); ?></a>
        ...
        <div class="px-4 py-4 space-y-2">
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" x-collapse class="pl-4 space-y-1 pb-2">
                    <a href="<?php echo e(url('/feature/live-stock')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">show_chart</span>
                        <?php echo e(__('landing.header.live_inventory_stock')); ?>

                    </a>
                    <a href="<?php echo e(url('/feature/inventory-management')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">inventory_2</span>
                        <?php echo e(__('landing.header.advanced_management')); ?>

                    </a>
                    <a href="<?php echo e(url('/feature/booking-online')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">calendar_today</span>
                        <?php echo e(__('landing.header.booking_online')); ?>

                    </a>
                    <a href="<?php echo e(url('/feature/quotation-invoicing')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">description</span>
                        <?php echo e(__('landing.header.quotation_invoicing')); ?>

                    </a>
                    <a href="<?php echo e(url('/feature/reporting')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">bar_chart</span>
                        <?php echo e(__('landing.header.rental_reports')); ?>
            ...
            <div x-data="{ open: false }">
                ...
                <div x-show="open" x-collapse class="pl-4 space-y-1 pb-2">
                    <a href="<?php echo e(url('/solution/photography-film')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">photo_camera</span>
                        <?php echo e(__('landing.header.photography_film')); ?>

                    </a>
                    <a href="<?php echo e(url('/solution/outdoor-camping')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">hiking</span>
                        <?php echo e(__('landing.header.outdoor_camping')); ?>

                    </a>
                    <a href="<?php echo e(url('/solution/party-event')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">celebration</span>
                        <?php echo e(__('landing.header.party_event')); ?>

                    </a>
                    <a href="<?php echo e(url('/solution/sound-system')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">speaker</span>
                        <?php echo e(__('landing.header.sound_system')); ?>

                    </a>
                    <a href="<?php echo e(url('/solution/vehicle')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">directions_car</span>
                        <?php echo e(__('landing.header.car_motorcycle')); ?>

                    </a>
                    <a href="<?php echo e(url('/solution/medical-equipment')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">medical_services</span>
                        <?php echo e(__('landing.header.medical_equipment')); ?>

                    </a>
                    <a href="<?php echo e(url('/solution/baby-mom-needs')); ?>" class="flex items-center gap-3 py-2 text-sm text-slate-600 dark:text-slate-400 hover:text-primary">
                        <span class="material-symbols-outlined text-base">child_care</span>
                        <?php echo e(__('landing.header.baby_mom_needs')); ?>

                    </a>
                </div>
            </div>

            <a href="<?php echo e(route('landing.pricing')); ?>" class="block py-3 text-sm font-medium hover:text-primary"><?php echo e(__('landing.header.pricing')); ?></a>
            <a href="<?php echo e(route('home')); ?>#testimonials" class="block py-3 text-sm font-medium hover:text-primary"><?php echo e(__('landing.header.testimonials')); ?></a>

            <div class="pt-4 border-t border-slate-200 dark:border-slate-800 space-y-2">
                <a href="/login-tenant" class="block w-full text-center py-2.5 text-sm font-bold rounded-lg border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800"><?php echo e(__('common.login')); ?></a>
                <a href="/register-tenant" class="block w-full text-center py-2.5 text-sm font-bold rounded-lg bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20"><?php echo e(__('common.get_started')); ?></a>
            </div>
        </div>
    </div>
</header>
<?php /**PATH /var/www/resources/views/landing/partials/header.blade.php ENDPATH**/ ?>